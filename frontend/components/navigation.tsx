...
export default function Navigation() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 pointer-events-none backdrop-blur-md border-b border-milk-tea-medium/20 animate-slide-down" style={{ backgroundColor: 'rgba(255, 255, 255, 0.15)' }}>
